 ...
 * Traveler class
 * 
 * @author Bernd OK (used from Proj2 solution with assumed permission)
 * 
 */
public class SpaceShip {
	...
	private int flightHours;				// TODO: NEW I ADDED THISSSSS		//int representing the number of flight hours of the last flight rounded to the rearest int.
	...
	// This is the public constructor																					/// i added onto this
	...
	// toString - no comment
	@Override
	public String toString() {		// TODO: ADditionally call toString on all passengers
		return "Spaceship [name=" + name + ", current=" + current
				+ ", destination=" + destination 
				+ ", capacity=" + capacity + ", travelers=" + numPassengers + ", flightHours" + getFlightHours() + "]";
	}	
}
