...
public class PersonWithAddress {
	...
	// Constructors
	public PersonWithAddress () {	// Default constructor (no-arg constructor)
		name = null;
		age = -1;
		addr = null;
	}
	
	public PersonWithAddress(String name, int age, Address addr) { 	// Fully parameterized constructor
		this.name = name;
		this.age = age;
		this.addr = addr;
	}
